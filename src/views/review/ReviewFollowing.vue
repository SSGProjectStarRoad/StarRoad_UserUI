      ...
      <div class="card">
        ...
        <div class="timeline-header">
          ...
          <div class="profile">
            ...
            <div class="__info">
              <span class="name username">지혜로운 미식가_76561</span>
              <span class="userinfo">리뷰 1개 </span>
            </div>
          </div>
        </div>
          ...
          <div class="gallery" style="border-radius: 4px">
            <div class="gallery-in">
              <div class="imgbox">
                <div class="imgin">
                  <img
                    src="https://ugc-images.catchtable.co.kr/rv/s3cSNdEyRL50KeKUYvOAJug/7e90e1e517c7438db576ac208d8d233b?detail750"
                    alt="" />
                </div>
              </div>
            </div>
        ...
        <div class="timeline-post-content">
          ...
          <div class="feedback-icons">
            <span class="feedback">
              <img src="https://ssl.pstatic.net/static/pup/emoji/face_savoring_food20220119222022.png" class=" emoji-icon"
                alt="" width="18" height="18" />음식이 맛있어요
            </span>
            <span class="feedback">
              <img src="https://ssl.pstatic.net/static/pup/emoji/green_heart20220119222224.png" class=" emoji-icon" alt=""
                width="18" height="18" />메뉴 구성이 알차요
            </span>
            <span class="feedback">
              <img src="https://ssl.pstatic.net/static/pup/emoji/couch_and_lamp20220119222025.png" class=" emoji-icon" alt=""
                width="18" height="18" />인테리어가 멋져요
            </span>
            <span class="feedback">
              <img src="https://ssl.pstatic.net/static/pup/emoji/rice_ball20220119222026.png" class=" emoji-icon" alt=""
                width="18" height="18" />혼밥하기 좋아요
            </span>
            <span class="feedback">
              <img src="https://ssl.pstatic.net/static/pup/emoji/light_bulb20220119222315.png" class=" emoji-icon" alt=""
                width="18" height="18" />컨셉이 독특해요
            </span>
          </div>
          ...
          <div class="restaurant-info">
            ...
            <div class="__info">
              ...
              <div class="__meta">일식 • 부산 광안리</div>
            </div>
        ...
        <div class="timeline-post-footer _10fm75h6 _10fm75hg _10fm75hj">
          <div class="__post-meta">
            <span class="__like la3t9m0" style="transform: none">0</span><span class="__comment">0</span>
          </div>
          <div class="_1vfgwok0">
